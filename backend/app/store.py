...
from .services.litellm_sync import LiteLLMSyncService
...
class PlatformStore:
    ...
    def preview_litellm_runtime_config(self) -> RuntimeConfigPreviewResponse:
        return self._litellm_sync_service().preview_litellm_runtime_config()

    def apply_litellm_runtime_config(self, output_dir: str | None = None) -> RuntimeConfigApplyResponse:
        return self._litellm_sync_service().apply_litellm_runtime_config(output_dir)

    def _sync_providers_to_litellm_config(self) -> None:
        self._litellm_sync_service().sync_providers_to_litellm_config()

    def sync_litellm_gateway_runtime(self) -> ProviderGatewaySyncResponse:  # noqa: C901
        return self._litellm_sync_service().sync_litellm_gateway_runtime()

    def _litellm_sync_service(self) -> LiteLLMSyncService:
        return LiteLLMSyncService(self)
